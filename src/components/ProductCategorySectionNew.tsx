...
import ProductBadgesNew from './ProductBadgesNew';
...
interface ProductCategorySectionNewProps {
...
export default function ProductCategorySectionNew({ 
  category, 
  products, 
  onViewAll,
  className = '' 
}: ProductCategorySectionNewProps) {
